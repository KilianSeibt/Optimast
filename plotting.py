...
def plot_map(country: str, city_coords: set[City] = None, tower_small_coords: set[Tower] = None, tower_large_coords: set[Tower] = None,
    ...
    COUNTRY_DATA[country]['latlon_plot'].plot(ax=ax, color="lightgray", edgecolor="black")
    ...
    def plot_points(points: set[Point], color: str = 'black', marker_size: int = 10) -> GeoDataFrame:
        ...
        for point in points:
            if point.lat is None:
                lat, lon = utm_to_latlon((point.x, point.y), country=country)
